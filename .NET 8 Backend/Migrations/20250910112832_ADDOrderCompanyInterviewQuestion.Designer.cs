...
namespace Interview_Simulator.Migrations
{
    ...
    [Migration("20250910112832_ADDOrderCompanyInterviewQuestion")]
    partial class ADDOrderCompanyInterviewQuestion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("QuestionsPerA")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(2);

                    b.Property<int>("QuestionsPerB")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(2);

                    b.Property<int>("QuestionsPerC")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(2);

                    b.Property<int>("QuestionsPerD")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(2);

                    b.Property<int>("QuestionsPerE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(2);
            ...
            modelBuilder.Entity("SavedCandidate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DomainConfiguration", b =>
                {
                    b.HasOne("Domain", "Domain")
                        ...
                        .HasForeignKey("DomainConfiguration", "DomainId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SavedCandidate", b =>
                {
                    ...
                    b.HasOne("CompanyInterview", "Interview")
                        .WithMany()
